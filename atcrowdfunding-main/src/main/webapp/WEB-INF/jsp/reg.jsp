...
<div class="container">
    ...
    <form class="form-signin" role="form">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="inputSuccess2" placeholder="请输入登录账号" autofocus>
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="inputSuccess" placeholder="请输入邮箱地址" style="margin-top:10px;">
